...
public final class Home_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\n");
      out.write("        ");
      org.apache.jasper.runtime.JspRuntimeLibrary.include(request, response, "/component/Banner.jsp", out, false);
      out.write("\n");
      out.write("\n");
      out.write("        <div class=\"container \" style=\"margin-top: 60px\">\n");
      out.write("            <div class=\"menuFilter\">\n");
      out.write("                <ul>\n");
      out.write("                    <li>Ngày tạo (Gần nhất)</li>\n");
      out.write("                    <li>Ngày tạo (Cũ nhất)</li>\n");
      out.write("                </ul>\n");
      out.write("            </div>\n");
      ...
      out.write("                <div id=\"loadMore\" page=\"1\" pageSize=\"3\">XEM THÊM</div>\n");
      out.write("            </div>\n");
      out.write("        </div>\n");
      out.write("        ");
      ...
      out.write("//                alert(parseInt($(\"#loadMore\").attr(\"data\"))+1)\n");
      out.write("                $.ajax({\n");
      out.write("                    url: '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${pageContext.request.contextPath}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("' + '/shops',\n");
      out.write("                    type: 'get',\n");
      out.write("                    data: {\n");
      out.write("                        page: parseInt($(\"#loadMore\").attr(\"page\")) + 1,\n");
      out.write("                        pageSize: parseInt($(\"#loadMore\").attr(\"pageSize\"))\n");
      out.write("                    },\n");
      out.write("                    success: function (data) {\n");
      out.write("                        dataFinal = JSON.parse(data)\n");
      out.write("                        console.log(dataFinal);\n");
      out.write("                        for (var i = 0; i < dataFinal.shops.length; i++) {\n");
      out.write("                            if (dataFinal.shops[i].openOrClose == true) {\n");
      out.write("                                $('#shops').append(function () {\n");
      out.write("                                    var html = `\n");
      out.write("                                        <div class=\"col-lg-4 portfolio-item mb-3 \">\n");
      out.write("                                                <div class=\"card h-100 cardShop\" onclick=\"window.location.href = '/ProjectJavaWeb/shop?shopId=` + dataFinal.shops[i].shopid + \"&userId=\" + dataFinal.shops[i].userid + `';\" >\n");
      out.write("                                                    <div class=\"card-body\">`;\n");
      out.write("\n");
      out.write("                                    if (dataFinal.shops[i].products.length > 0) {\n");
      out.write("                                        html += `\n");
      out.write("                                        <div  class=\"carousel slide\" id=\"productsShop`+dataFinal.shops[i].shopid+`\" style=\"height: auto\">\n");
      out.write("                                            <div class=\"carousel-inner\">\n");
      out.write("                                                <div class=\"carousel-item active\">\n");
      out.write("                                                    <img src=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${pageContext.request.contextPath}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("/image?imgname=` + dataFinal.shops[i].products[0].image + `\" alt=\"Los Angeles\" class=\"object-fit\">      \n");
      out.write("                                                </div>\n");
      out.write("                                        `;\n");
      out.write("                                        for (var j = 1; j < dataFinal.shops[i].products.length; j++) {\n");
      out.write("                                            html += `\n");
      out.write("                                             <div class=\"carousel-item \">\n");
      out.write("                                                        <img src=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${pageContext.request.contextPath}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("/image?imgname=` + dataFinal.shops[i].products[j].image + `\" alt=\"Los Angeles\" class=\"object-fit\">\n");
      out.write("                                            </div>\n");
      out.write("                                            `;\n");
      out.write("                                        }\n");
      out.write("                                        html += `\n");
      ...
      out.write("                                                            <div>` + dataFinal.shops[i].title + `</div>\n");
      out.write("                                                        </h4>\n");
      out.write("                                                        <p class=\"card-text\">` + dataFinal.shops[i].description + `</p>\n");
      out.write("                                                    </div>\n");
      out.write("                                                </div>\n");
      out.write("                                                <a class=\"carousel-control-prev\" onC href=\"#productsShop`+dataFinal.shops[i].shopid+`\" data-slide=\"prev\" style=\"position: absolute;top: -30%; left: 6%;\">\n");
      out.write("                                                    <span class=\"carousel-control-prev-icon\"></span>\n");
      out.write("                                                </a>\n");
      out.write("                                                <a class=\"carousel-control-next\" href=\"#productsShop`+dataFinal.shops[i].shopid+`\" data-slide=\"next\" style=\"position: absolute;top: -30%; right: 6%;\">\n");
      ...
      out.write("                            }\n");
      out.write("                        }\n");
      out.write("                        $(\"#loadMore\").attr(\"page\", parseInt($(\"#loadMore\").attr(\"page\")) + 1);\n");
      out.write("                        if (dataFinal.shops.length < parseInt($(\"#loadMore\").attr(\"pageSize\"))) {\n");
  ...
  private boolean _jspx_meth_c_if_0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_forEach_0, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_forEach_0)
    ...
    _jspx_th_c_if_0.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${x.openOrClose==true}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null)).booleanValue());
    ...
    if (_jspx_eval_c_if_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        ...
        out.write("                                </div>\n");
        out.write("                            </div>\n");
        out.write("                            <a class=\"carousel-control-prev\" onC href=\"#productsShop");
        ...
        out.write("\" data-slide=\"prev\" style=\"position: absolute;top: -30%; left: 6%;\">\n");
        out.write("                                <span class=\"carousel-control-prev-icon\"></span>\n");
        out.write("                            </a>\n");
        out.write("                            <a class=\"carousel-control-next\" href=\"#productsShop");
        out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${x.shopId}", java.lang.String.class, (PageContext)_jspx_page_context, null));
        out.write("\" data-slide=\"next\" style=\"position: absolute;top: -30%; right: 6%;\">\n");
        out.write("                                <span class=\"carousel-control-next-icon\"></span>\n");
        out.write("                            </a>\n");
        out.write("                        </div>\n");
        out.write("                    ");
  ...
  private boolean _jspx_meth_c_url_0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_if_0, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_forEach_0)
    ...
    _jspx_th_c_url_0.setValue("/shop");
  ...
  private boolean _jspx_meth_c_param_1(javax.servlet.jsp.tagext.JspTag _jspx_th_c_url_0, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_forEach_0)
    ...
    _jspx_th_c_param_1.setValue((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${x.userId}", java.lang.String.class, (PageContext)_jspx_page_context, null));
